...
You can download an installer for a preferable version on [releases page](https://nodejs.org/en/download/releases/). The most recently tested version is `10`.
...
If you're using Windows, you must run `mill --no-server` instead of `mill`.
